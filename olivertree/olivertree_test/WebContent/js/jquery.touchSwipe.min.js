...
// wrapresize();
			...
			// set browser prefix
			if (navigator.userAgent.match(/mozilla/i))	browserPrefix = '-moz-';
			if (navigator.userAgent.match(/webkit/i))	browserPrefix = '-webkit-';
			if (navigator.userAgent.match(/opera/i))	browserPrefix = '-o-';
			if (navigator.userAgent.match(/msie/i))		browserPrefix = '-ms-';
			...
			for (i=0; i<scrollorama.settings.blocks.length; i++) {
				...
				block.attr('data-top-id',block.offset().top);
				blocks.push({
					block: block,
